...
public class RequestItemRestControllerUT extends BaseTestCase{
    ...
    public void testRequestWithInvalidRequestingInst() throws JSONException {
        ...
        ItemRequestInformation itemRequestInformation = ItemRequestInformation
    		.builder()
	        .patronBarcode("45678915")
	        .requestType("Borrow Direct")
	        .itemOwningInstitution("CUL")
	        .requestingInstitution("PULd")
	        .emailAddress("hemalatha.s@htcindia.com")
	        .build();
    ...
    public void testcheckinItemRequest() throws IOException {
        ...
        ItemCheckInRequest itemCheckInRequest = ItemCheckInRequest
    		.builder()
    		.patronIdentifier("45678915")
    		.itemBarcodes(Arrays.asList("123"))
    		.itemOwningInstitution("PUL")
    		.build();
    ...
    public void testItemInformationPUL(){
        ...
        ItemInformationRequest itemInformationRequest = ItemInformationRequest
    		.builder()
	        .itemBarcodes(Arrays.asList("233"))
	        .itemOwningInstitution("PUL")
	        .build();
    ...
    public void testcancelHoldItemRequest() throws IOException {
        ItemHoldCancelRequest itemHoldCancelRequest = ItemHoldCancelRequest
    		.builder()
			.itemBarcodes(Arrays.asList("3216549874100225"))
			.itemOwningInstitution("PUL")
			.pickupLocation("PB")
			.bibId("3256")
			.patronIdentifier("456328965")
			.trackingId("2")
			.build();
    ...
    public void testCheckoutItemRequest() throws IOException {
        ...
        String response = responseEntity.getBody().toString();
        ItemCheckOutRequest itemCheckOutRequest = ItemCheckOutRequest
    		.builder()
    		.patronIdentifier("45678915")
    		.itemBarcodes(Arrays.asList("123"))
    		.itemOwningInstitution("PUL")
    ...
    public void testHoldRequestItem() throws IOException {
        ItemHoldRequest itemHoldRequest = ItemHoldRequest
    		.builder()
    		.itemOwningInstitution("PUL")
	        .trackingId("564")
	        .callNumber("5645")
	        .itemBarcodes(Arrays.asList("32101047717911"))
	        .patronIdentifier("42659872")
	        .bibId("14533")
	        .author("John")
	        .pickupLocation("PB")
	        .build();
    ...
    public void testCreateBibRequest() throws IOException {
        ItemCreateBibRequest itemCreateBibRequest = ItemCreateBibRequest
    		.builder()
    		.patronIdentifier("4568723")
    		.titleIdentifier("test")
    		.itemBarcodes(Arrays.asList("4564"))
    		.itemOwningInstitution("PUL")
    		.build();
    ...
    public void testRecallItem() throws IOException {
        ItemRecallRequest itemRecallRequest = ItemRecallRequest
    		.builder()
	        .itemBarcodes(Arrays.asList("254"))
	        .itemOwningInstitution("PUL")
	        .patronIdentifier("4856956")
	        .bibId("4563")
	        .pickupLocation("PB")
	        .build();
    ...
    public void testRequestItem() {
        ...
        try {
            ItemRequestInformation itemRequestInfo = ItemRequestInformation
        		.builder()
	            .patronBarcode("32101077423406")
	            .itemBarcodes(Arrays.asList("3652147896532455"))
	            .requestType(ReCAPConstants.REQUEST_TYPE_RETRIEVAL)
	            .requestingInstitution(ReCAPConstants.PRINCETON)
	            .emailAddress("ksudhish@gmail.com")
	            .build();
    ...
    public void testQueuewithObject() {
        ...
        try {
            ItemRequestInformation itemRequestInformation = ItemRequestInformation
        		.builder()
	            .itemBarcodes(Arrays.asList("PULTST54321"))
	            .patronBarcode("45678913")
	            .requestType(ReCAPConstants.REQUEST_TYPE_RETRIEVAL)
	            .requestingInstitution(ReCAPConstants.PRINCETON)
	            .emailAddress("ksudhish@gmail.com")
	            .deliveryLocation("htcsc")
	            .titleIdentifier("New BooK")
	            .build();
